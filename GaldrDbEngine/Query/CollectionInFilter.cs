...
/// matching one of the specified values.
/// </summary>
...
public sealed class CollectionInFilter<TDocument, TElement, TField> : IFieldFilter
{
    ...
    /// <summary>The values to match against.</summary>
    ...
    /// <summary>
    /// Creates a new collection IN filter.
    /// </summary>
    /// <param name="field">The collection field to filter on.</param>
    /// <param name="values">The values to match against.</param>
    public CollectionInFilter(GaldrCollectionField<TDocument, TElement, TField> field, TField[] values)
    {
        _field = field;
        _valuesArray = values;
