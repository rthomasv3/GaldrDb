#!/bin/bash
# Creates the AppRun launcher script for GaldrDb Browser AppImage
...
# Example: GTK_THEME=Adwaita:light ./GaldrDbBrowser.AppImage
...
exec "${APPDIR}/usr/bin/GaldrDbBrowser" "$@"
EOF
