...
def main():
    ...
    patches = [
        # Fedora/RHEL paths
        ("/usr/libexec/webkit2gtk-4.1", "/tmp/galdrdb-webkit/libexec"),  # 27 chars each
        ("/usr/lib64/webkit2gtk-4.1/injected-bundle/", "/tmp/galdrdb-webkit/lib64/injected-bundle/"),  # 42 chars
        # Ubuntu/Debian paths
        ("/usr/lib/x86_64-linux-gnu/webkit2gtk-4.1", "/tmp/galdrdb-webkit/lib/x86_64-linux-gnu"),  # 42 chars each
        ("/usr/lib/x86_64-linux-gnu/webkit2gtk-4.1/injected-bundle/", "/tmp/galdrdb-webkit/lib/x86_64-linux-gnu/injected-bundle/"),  # 59 chars
    ]
